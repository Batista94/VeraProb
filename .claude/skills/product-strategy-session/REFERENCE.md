...
```
Week 1:
â”œâ”€ Day 1-2: Positioning & Market Context
â”‚  â”œâ”€ skills/positioning-workshop/SKILL.md (90 min)
â”‚  â”œâ”€ skills/proto-persona/SKILL.md (60 min)
â”‚  â””â”€ skills/jobs-to-be-done/SKILL.md (60 min)
â”‚
â”œâ”€ Day 3-5: Problem Framing & Validation
â”‚  â”œâ”€ skills/problem-framing-canvas/SKILL.md (120 min)
â”‚  â”œâ”€ skills/problem-statement/SKILL.md (30 min)
â”‚  â””â”€ [Optional] skills/customer-journey-mapping-workshop/SKILL.md (90 min)
â”‚
â””â”€ Decision: Validate problem? (if NO, +1 week discovery)

Week 2:
â”œâ”€ Day 1-3: Solution Exploration
â”‚  â”œâ”€ skills/opportunity-solution-tree/SKILL.md (90 min)
â”‚  â”œâ”€ skills/epic-hypothesis/SKILL.md (60 min per epic)
â”‚  â””â”€ [Optional] skills/user-story-mapping-workshop/SKILL.md (120 min)
â”‚
â”œâ”€ Decision: Test solutions? (if YES, +1-2 weeks experiments)
â”‚
â””â”€ Day 4-5: Prioritization & Roadmap
   â”œâ”€ skills/prioritization-advisor/SKILL.md (30 min)
   â”œâ”€ Score & prioritize epics (90 min)
   â”œâ”€ Sequence roadmap (60 min)
   â””â”€ [Optional] skills/tam-sam-som-calculator/SKILL.md (60 min)

Week 3:
â””â”€ Stakeholder Alignment
   â”œâ”€ [Optional] skills/press-release/SKILL.md (60 min)
   â”œâ”€ Present strategy (60 min)
   â””â”€ Refine based on feedback (1-2 days)

Week 4:
â””â”€ Execution Planning
   â”œâ”€ skills/epic-breakdown-advisor/SKILL.md (90 min)
   â”œâ”€ skills/user-story/SKILL.md (30 min per story)
   â””â”€ Plan first sprint (60 min)
```
...
### External Frameworks
- Teresa Torres, *Continuous Discovery Habits* (2021) â€” Opportunity solution tree framework
- Jeff Gothelf, *Lean UX* (2016) â€” Hypothesis-driven product development
- Marty Cagan, *Inspired* (2017) â€” Product discovery process

### Dean's Work
- Productside Blueprint â€” Strategic product discovery
