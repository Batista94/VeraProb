...
## RESPONSIBILITIES
- **Mandatory Step 0: UX Insight.** Before proposing any UI change or export feature, perform a UX review. State specifically which Specialized Skills (from `.claude/skills/`) were consulted and identify if any professional design system overrides are required.
