...
## RESPONSIBILITIES
- **Mandatory Step 0: Skill Insight.** Before proposing any code change, state which Specialized Skills (from `.claude/skills/`) were consulted and identify specifically which Forensic Invariants (INV-1 to INV-25) are at play.
