...
**Integrated Services (free/freemium tier):** Supabase · MapTiler · Sentry · PostHog · Resend
...
## THE 25 NON-NEGOTIABLE INVARIANTS (THE LAW)
...
25. **FREE/FREEMIUM INTEGRATION GATE (INV-25)** — Every third-party service integrated into VeraProb MUST have a free or freemium tier that covers the pre-revenue stage. It MUST also enforce industry-standard information security practices (SOC 2, GDPR compliance, or equivalent). Paid-only dependencies require explicit PO sign-off. Prefer services already in the stack (Supabase, MapTiler, Sentry, PostHog, Resend) before introducing new vendors. Open-source self-hosted alternatives are preferred when operational overhead is acceptable.
