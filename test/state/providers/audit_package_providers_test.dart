...
void main() {
  group('audit_package_providers.dart Tests', () {
    ...
    test('provider initial state test structure', () {
      ...
      expect(
        container.exists(auditPackageServiceProvider),
        isFalse,
    ...
    test('provider initial state test structure', () {
      ...
      // We check that container has the provider without instantiating dependencies that might throw UnimplementedError
      expect(
        container.exists(csvExportServiceProvider),
        isFalse,
      ); // Initially false before being read
    });
    ...
    test('provider initial state test structure', () {
      ...
      // We check that container has the provider without instantiating dependencies that might throw UnimplementedError
      expect(
        container.exists(pdfExportServiceProvider),
        isFalse,
      ); // Initially false before being read
    });
  });
