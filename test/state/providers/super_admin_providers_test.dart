...
void main() {
  group('super_admin_providers.dart Tests', () {
    ...
    test('provider initial state test structure', () {
      ...
      expect(
        container.exists(superAdminRepositoryProvider),
        isFalse,
    ...
    test('provider initial state test structure', () {
      ...
      // We check that container has the provider without instantiating dependencies that might throw UnimplementedError
      expect(
        container.exists(createOrganizationHandlerProvider),
        isFalse,
      ); // Initially false before being read
    });
    ...
    test('provider initial state test structure', () {
      ...
      // We check that container has the provider without instantiating dependencies that might throw UnimplementedError
      expect(
        container.exists(cnpjLookupServiceProvider),
        isFalse,
      ); // Initially false before being read
    });
  });
