...
//
// P2: novos testes de comportamento adicionados (TDD).
// Goldens preservados — regen obrigatório via `make goldens` após modificações
// no layout (card estruturado + payload colapsado + HashText).
...
void main() {
  ...
  // ── Golden tests (regen via `make goldens` after P2 layout changes) ────────
