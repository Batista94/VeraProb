...
void main() {
  ...
  group('CreateOrganizationHandler', () {
    group('CNPJ validation', () {
      test('throws DomainException for CNPJ with fewer than 14 digits',
          () async {
        await expectLater(
      ...
      test('throws DomainException for CNPJ with more than 14 digits',
          () async {
        await expectLater(
      ...
      test('strips formatting before counting (00.000.000/0001-99 has 14 digits)',
          () async {
