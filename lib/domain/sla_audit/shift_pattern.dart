...
class ShiftPattern extends Equatable {
  ...
  /// Required vehicle category for this shift. Trips fulfilled by a vehicle of
  /// inferior category trigger [SLAPenalties.downgradePenaltyFlat].
  ///
  /// Defaults to [VehicleCategory.conventional] for backward compat when
  ...
  factory ShiftPattern.fromJson(Map<String, dynamic> json) {
    ...
    return ShiftPattern._(
      ...
      // Backward compat: field absent in plans created before this sprint.
