...
class AlertDerivationService {
  ...
  static OperationalAlert? deriveFrom({
    ...
    switch (state.status) {
      ...
      case ExecutionStatus.completedWithGaps:
        return _deriveEvidenceGapAlert(
          state: state,
          evaluatedAtUtc: evaluatedAtUtc,
          triggeringEventId: triggeringEventId,
          traceId: traceId,
  ...
  static OperationalAlert _deriveNoShowAlert({
    required ContractualExecutionState state,
    required DateTime evaluatedAtUtc,
    String? triggeringEventId,
    String? traceId,
  ...
  static OperationalAlert _deriveEvidenceGapAlert({
    required ContractualExecutionState state,
    required DateTime evaluatedAtUtc,
    String? triggeringEventId,
    String? traceId,
  ...
  static OperationalAlert? _derivePenaltyAlert({
    required ContractualExecutionState state,
    required List<EvaluationDecision> decisions,
    required DateTime evaluatedAtUtc,
    String? triggeringEventId,
