            ...
            try {
              ...
              await serviceRoleClient.rpc(
                ...
                params: {
                  'p_org_id': org.orgId,
                  'p_reason':
                      'PBT formal predicate iter $i — $numAdmins admins',
              ...
              expect(
                ...
                isNotEmpty,
                reason:
                    'Org $i deve ter pelo menos 1 user_role para verificar',
              );
          ...
          () async {
            ...
            try {
              ...
              final hasActiveAdmin =
                  userRoles.any((row) => row['is_active'] == true);
              ...
              expect(status, isNot(equals('ARCHIVED')),
