...
void main() {
  group(
    'Feature: superadmin-org-management-e2e-tests, '
    ...
    () {
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        test(
          'POSITIVE iter $i: valid string (${text.length} chars) → '
          'isJustificationValid returns true',
          () {
            expect(
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        test(
          'NEGATIVE (whitespace) iter $i: whitespace-only string '
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        test(
          'NEGATIVE (short) iter $i: short string '
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        test(
          'BOUNDARY iter $i: exactly 10 chars after trim → '
          'isJustificationValid returns true',
          () {
            expect(
              text.trim().length,
      ...
      for (var i = 0; i < iterations; i++) {
        ...
        test(
          'BELOW BOUNDARY iter $i: exactly 9 chars after trim → '
          'isJustificationValid returns false',
          () {
            expect(
              text.trim().length,
