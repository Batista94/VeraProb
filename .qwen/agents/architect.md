...
## RESPONSIBILITIES
- **Mandatory Step 0: Structural Integrity Check.** Before proposing any domain or architectural change, state which Specialized Skills (from `.qwen/skills/`) were consulted and identify specifically which Forensic Invariants (INV-1 to INV-25) are at play.
