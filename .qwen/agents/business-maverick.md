...
## RESPONSIBILITIES
- **Mandatory Step 0: ROI Analysis.** Before proposing any feature or roadmap change, perform a business impact analysis. State which Specialized Skills (from `.qwen/skills/`) were consulted and identify specifically how this reduces "Margin Erosion" or protects "Market Dominance".
