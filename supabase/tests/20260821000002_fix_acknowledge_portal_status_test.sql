...
VALUES ('33333333-3333-3333-3333-333333333331', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222221', '44444444-4444-4444-4444-444444444441', 0, 5, NOW() + INTERVAL '1 day');

INSERT INTO public.dispute_portal_tokens (id, organization_id, queue_entry_id, token, access_count, max_access_count, expires_at_utc)
VALUES ('33333333-3333-3333-3333-333333333332', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444442', 0, 5, NOW() + INTERVAL '1 day');

INSERT INTO public.dispute_portal_tokens (id, organization_id, queue_entry_id, token, access_count, max_access_count, expires_at_utc)
VALUES ('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222223', '44444444-4444-4444-4444-444444444443', 0, 5, NOW() + INTERVAL '1 day');
...
-- Test 2: Status is now 'acknowledged'
...
-- Test 5: Status is now 'acknowledged'
