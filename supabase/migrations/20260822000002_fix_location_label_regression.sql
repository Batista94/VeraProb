-- =============================================================================
-- Migration: fix_location_label_regression
-- Purpose:   Restores the COALESCE priority (geofence_name → address →
--            location_label → lat,lng) in read_infraction_context that was
--            accidentally regressed by 20260821000001_enhance_infraction_context_rpc.sql.
--            All fields added by that migration (clause_ref, primary_evidence_lat,
--            primary_evidence_lng) are preserved.
--
...
BEGIN
  ...
  -- Restored from 20260820000003; regressed by 20260821000001 (which collapsed to lat,lng only).
