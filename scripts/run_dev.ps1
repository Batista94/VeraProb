...
Depois preencha com as credenciais do projeto PactaFlow-dev no Supabase.
"@
    exit 1
}

Write-Host "🔧 [DEV] Iniciando PactaFlow com credenciais de desenvolvimento..." -ForegroundColor Cyan
